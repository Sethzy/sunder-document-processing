    ...
    >
      ...
      >
        <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
          {/* Outer highlight edge (chamfered titanium look) */}
          <path
            d="M2 73C2 32.6832 34.6832 0 75 0H357C397.317 0 430 32.6832 430 73V809C430 849.317 397.317 882 357 882H75C34.6832 882 2 849.317 2 809V73Z"
            className="fill-[#86868B] dark:fill-[#404040] stroke-white/20"
            strokeWidth="1"
          />
          <path
            d="M0 171C0 170.448 0.447715 170 1 170H3V204H1C0.447715 204 0 203.552 0 203V171Z"
            className="fill-[#86868B] dark:fill-[#404040]"
          />
          <path
          ...
          />
          <path
            d="M5 74C5 35.0655 36.0655 3 75 3H357C395.935 3 427 35.0655 427 74V808C427 846.935 395.935 878 357 878H75C36.0655 878 5 846.935 5 808V74Z"
            className="fill-[#3A3A3C] dark:fill-[#262626]"
          />
        </g>
        ...
        <path
          ...
          className="fill-[#E5E5E5] stroke-[#86868B] stroke-[0.5] dark:fill-[#404040] dark:stroke-[#404040]"
